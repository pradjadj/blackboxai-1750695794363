...
class Duitku_Alfamart extends Duitku_Payment_Gateway {
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            'enabled' => array(
                ...
                'type' => 'checkbox',
                'label' => __('Enable Alfamart Payment', 'duitku'),
                'default' => 'yes'
            ),
            'title' => array(
    ...
    public function receipt_page($order_id) {
        ...
        echo '<p>' . esc_html__('Silakan bayar dengan Kode Pembayaran Alfamart berikut:', 'duitku') . '</p>';
        if ($payment_code) {
            echo '<div class="va-number-box">';
            echo '<span class="va-number">' . esc_html($payment_code) . '</span>';
            echo '<button class="copy-button" onclick="copyToClipboard(\'' . esc_js($payment_code) . '\')">' . esc_html__('Copy', 'duitku') . '</button>';
            echo '</div>';
        }
