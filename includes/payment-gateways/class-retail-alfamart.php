...
class Duitku_Alfamart extends WC_Payment_Gateway {
    ...
    public function process_payment($order_id) {
        ...
        try {
            ...
            $order->update_meta_data('_duitku_payment_code', $body['paymentCode']);
            $order->update_meta_data('_duitku_payment_method', $this->payment_code);
    ...
    public function receipt_page($order_id) {
        $order = wc_get_order($order_id);
        $payment_code = $order->get_meta('_duitku_payment_code');
