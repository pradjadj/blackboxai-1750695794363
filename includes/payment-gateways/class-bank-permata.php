...
class Duitku_Permata extends WC_Payment_Gateway {
    ...
    public function __construct() {
        ...
        $this->method_title = 'Duitku - Permata Bank Virtual Account';
        $this->method_description = 'Pembayaran melalui Virtual Account Permata Bank';
        $this->has_fields = false;
        $this->payment_code = 'BT'; // Permata Bank payment code
        ...
        $this->description = sprintf(
            'Pembayaran menggunakan Virtual Account Permata Bank. Expired dalam %d menit.',
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            'enabled' => array(
                ...
                'type' => 'checkbox',
                'label' => 'Enable Permata Bank Virtual Account Payment',
                'default' => 'yes'
            ),
            'title' => array(
                ...
                'default' => 'Permata Bank Virtual Account',
                'desc_tip' => true,
            ),
            'description' => array(
    ...
    public function receipt_page($order_id) {
        ...
        if ($va_number) {
            ...
            echo '<h3>' . esc_html__('Permata Bank Virtual Account Number', 'duitku') . '</h3>';
