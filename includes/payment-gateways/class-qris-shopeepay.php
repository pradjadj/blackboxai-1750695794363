...
class Duitku_ShopeePay extends WC_Payment_Gateway {
    protected $logger;
    public $settings;

    public function __construct() {
        $this->id = 'duitku_shopeepay';
        $this->method_title = 'Duitku - QRIS ShopeePay';
        $this->method_description = 'Pembayaran melalui QRIS ShopeePay';
        ...
        $this->enabled = 'yes';
        $this->title = 'QRIS ShopeePay';
        $this->description = sprintf(
            'Pembayaran menggunakan QRIS ShopeePay. Expired dalam %d menit.',
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            'enabled' => array(
                ...
                'type' => 'checkbox',
                'label' => 'Enable QRIS ShopeePay Payment',
                'default' => 'yes'
            ),
            'title' => array(
    ...
    public function process_payment($order_id) {
        ...
        try {
            ...
            // Update order status
            $order->update_status('pending', __('Awaiting QRIS ShopeePay payment', 'duitku'));
            ...
            $this->logger->log('QRIS ShopeePay Payment processing failed: ' . $e->getMessage());
    ...
    public function receipt_page($order_id) {
        ...
        if ($qr_string) {
            ...
            echo '<ol>';
            echo '<li>' . esc_html__('Buka aplikasi ShopeePay di smartphone Anda', 'duitku') . '</li>';
