...
class Duitku_BSI extends Duitku_Payment_Gateway {
    public function __construct() {
        ...
        $this->title = $this->get_option('title', 'BSI Virtual Account');
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            'enabled' => array(
                ...
                'type' => 'checkbox',
                'label' => __('Enable BSI Virtual Account Payment', 'duitku'),
                'default' => 'yes'
            ),
            'title' => array(
                ...
                'default' => __('BSI Virtual Account', 'duitku'),
                'desc_tip' => true,
            ),
            'description' => array(
                ...
                'default' => __('Pay using BSI Virtual Account. The payment will expire after the specified time limit.', 'duitku'),
                'desc_tip' => true,
            ),
            'instructions' => array(
                ...
                'default' => __(
                    "1. Save your BSI Virtual Account number\n" .
                    "2. Login to your BSI Mobile Banking or Internet Banking\n" .
    ...
    public function process_payment($order_id) {
        ...
        try {
            ...
            // Update order status
            $order->update_status('pending', __('Awaiting BSI Virtual Account payment', 'duitku'));
            ...
            $this->logger->log('BSI VA Payment processing failed: ' . $e->getMessage());
    ...
    public function receipt_page($order_id) {
        ...
        echo '<p>' . esc_html__('Silakan transfer ke Virtual Account BSI berikut:', 'duitku') . '</p>';
        if ($va_number) {
