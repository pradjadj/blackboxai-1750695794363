...
class Duitku_BSI extends WC_Payment_Gateway {
    protected $logger;
    public $settings;
    ...
    public function __construct() {
        ...
        $this->description = sprintf(
            'Pembayaran menggunakan Virtual Account BSI. Expired dalam %d menit.',
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            'enabled' => array(
                ...
                'type' => 'checkbox',
                'label' => 'Enable BSI Virtual Account Payment',
                'default' => 'yes'
            ),
            'title' => array(
    ...
    public function receipt_page($order_id) {
        ...
        if ($va_number) {
            ...
            echo '<h3>' . esc_html__('BSI Virtual Account Number', 'duitku') . '</h3>';
