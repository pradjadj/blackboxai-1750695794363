...
class Duitku_CIMB extends Duitku_Payment_Gateway {
    public function __construct() {
        ...
        $this->title = $this->get_option('title', 'CIMB Virtual Account');
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            'enabled' => array(
                ...
                'type' => 'checkbox',
                'label' => __('Enable CIMB Virtual Account Payment', 'duitku'),
                'default' => 'yes'
            ),
            'title' => array(
                ...
                'default' => __('CIMB Virtual Account', 'duitku'),
                'desc_tip' => true,
            ),
            'description' => array(
                ...
                'default' => __('Pay using CIMB Virtual Account. The payment will expire after the specified time limit.', 'duitku'),
                'desc_tip' => true,
            ),
            'instructions' => array(
                ...
                'default' => __(
                    "1. Save your CIMB Virtual Account number\n" .
                    "2. Login to your CIMB Mobile Banking or Internet Banking\n" .
    ...
    public function process_payment($order_id) {
        ...
        try {
            ...
            // Update order status
            $order->update_status('pending', __('Awaiting CIMB Virtual Account payment', 'duitku'));
            ...
            $this->logger->log('CIMB VA Payment processing failed: ' . $e->getMessage());
    ...
    public function receipt_page($order_id) {
        ...
        echo '<p>' . esc_html__('Silakan transfer ke Virtual Account CIMB berikut:', 'duitku') . '</p>';
        if ($va_number) {
