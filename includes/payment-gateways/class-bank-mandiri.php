...
class Duitku_Mandiri extends Duitku_Payment_Gateway {
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            'enabled' => array(
                ...
                'type' => 'checkbox',
                'label' => __('Enable Mandiri Virtual Account Payment', 'duitku'),
                'default' => 'yes'
            ),
            'title' => array(
                ...
                'default' => __('Mandiri Virtual Account', 'duitku'),
                'desc_tip' => true,
            ),
            'description' => array(
                ...
                'default' => __('Pay using Mandiri Virtual Account. The payment will expire after the specified time limit.', 'duitku'),
                'desc_tip' => true,
            ),
            'instructions' => array(
                ...
                'default' => __(
                    "1. Save your Mandiri Virtual Account number\n" .
                    "2. Login to your Mandiri Mobile Banking or Internet Banking\n" .
    ...
    public function receipt_page($order_id) {
        ...
        echo '<p>' . esc_html__('Silakan transfer ke Virtual Account Mandiri berikut:', 'duitku') . '</p>';
        if ($va_number) {
