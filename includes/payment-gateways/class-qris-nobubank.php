...
class Duitku_NobuBank extends Duitku_Payment_Gateway {
    public function __construct() {
        ...
        $this->title = $this->get_option('title', 'Nobu Bank QRIS');
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            'enabled' => array(
                ...
                'type' => 'checkbox',
                'label' => __('Enable Nobu Bank QRIS Payment', 'duitku'),
                'default' => 'yes'
            ),
            'title' => array(
                ...
                'default' => __('Nobu Bank QRIS', 'duitku'),
                'desc_tip' => true,
            ),
            'description' => array(
                ...
                'default' => __('Pay using Nobu Bank QRIS. Scan the QR code using your mobile banking app.', 'duitku'),
                'desc_tip' => true,
            ),
            'expiry_period' => array(
    ...
    public function process_payment($order_id) {
        ...
        try {
            ...
            // Update order status
            $order->update_status('pending', __('Awaiting Nobu Bank QRIS payment', 'duitku'));
            ...
            $this->logger->log('Nobu Bank QRIS Payment processing failed: ' . $e->getMessage());
